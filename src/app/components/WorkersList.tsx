...
import { Search, User, ChevronRight, Star, TrendingUp } from 'lucide-react';
    ...
    <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
      ...
      <div className="p-6 border-b border-gray-200 dark:border-gray-700">
        ...
        <div className="flex gap-2 flex-wrap">
          ...
          >
            Activos ({mockWorkers.filter(w => w.status === 'active').length})
          </button>
          <button
          ...
          >
            Pendientes ({mockWorkers.filter(w => w.status === 'pending').length})
          </button>
          <button
          ...
          >
            Evaluados ({mockWorkers.filter(w => w.status === 'evaluated').length})
          </button>
        </div>
      </div>
            ...
            {filteredWorkers.map(worker => (
              ...
              >
                <div className="flex items-start gap-3">
                  {/* Avatar */}
                  <div className="w-12 h-12 bg-[#f3e8ff] dark:bg-purple-900/30 rounded-full flex items-center justify-center flex-shrink-0">
